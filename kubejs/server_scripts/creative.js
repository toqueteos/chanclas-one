  ...
  e.custom(
    {
      ...
      "inputs": [
        {"type": "pneumaticcraft:stacked_item",
          "item": "upgradednetherite:ultimate_upgraded_netherite_ingot"},
        {"type": "pneumaticcraft:stacked_item",
  ...
  e.custom(
    {
      ...
      "tier": 4,
      "pattern": [" BBBCBBB ", "BADDEDDAB", "BDAFGFADB", "BDFJHJFDB", "CEGHIHGEC", "BDFJHJFDB", "BDAFGFADB", "BADDEDDAB", " BBBCBBB "],
      "key": {
  ...
  e.custom(
    {
      "type": "extendedcrafting:shaped_table",
      "tier": 4,
      "pattern": ["ABCDEFGHI", "JKLLLLLKM", "NOPP PPOR", "SOPTUTPOV", "WO XYZ O0", "1OPT2TPO3", "4OPP PPO5", "6KLLLLLK7", "89-+.!,;:"],
      "key": {
        "A": { "item": "tconstruct:magma_bucket" },
        "B": { "item": "bloodmagic:life_essence_bucket" },
        "C": { "item": "kubejs:molten_signalum_bucket" },
        ...
        "M": { "item": "kubejs:molten_lumium_bucket" },
        ...
        ";": { "item": "kubejs:molten_enderium_bucket" },
